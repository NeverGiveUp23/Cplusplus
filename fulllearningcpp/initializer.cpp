...
int main() {
    ...
    // use direct initialization when your going to actually be using the initial value
    int li{0};
    ...
    // we should use \n to end the line and start a new one while the C++ output system self flushes

    // flushing is when all data is collected in the buffer is transferred to its destination
    // the buffer is a region of memory where the requested output is stored
